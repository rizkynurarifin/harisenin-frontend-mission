// src/components/organisms/PremiumOverlay.tsx
...
export const PremiumOverlay = () => {
    return (
        <div className="absolute inset-0 z-30 flex items-center justify-center px-4">
            ...
            {/* Modal Box (Fixed 600px di Figma) */}
            <div className="relative z-10 w-full max-w-150 flex flex-col items-center text-center">
                <h1 className="text-text-light-primary font-bold text-2xl lg:text-[32px] mb-2 flex items-center">
                    Layanan Premium🌟
                </h1>
                <p className="text-text-light-primary text-[16px] lg:text-lg mb-7.5 lg:mb-15">
                    Tingkatkan paket anda untuk dapat menonton video ini.
                </p>

                <h2 className="text-white font-medium text-sm lg:text-lg mb-2 lg:mb-4">
                    Kenapa Harus Berlangganan?
                </h2>

                {/* Grid Benefits (Disesuaikan untuk modal) */}
                <div className="grid grid-cols-3 gap-1.5 lg:gap-3 w-full">
                    <BenefitItem
                        icon={
                ...
                <Button
                    to="/subscription"
                    variant="primary"
                    className="mt-7.5 lg:mt-15 min-w-44 max-w-48.25"
                >
                    Ubah Jadi Premium
                </Button>
            </div>
