        ...
        <div className="flex items-center gap-4">
                ...
                >
                    <DropdownMenu.Trigger asChild>
                        <ControlButton>
                            ...
                            >
                                <path
                                    d="M7 21L16.9167 14L7 7M9.33333 11.5033L12.8683 14L9.33333 16.4967M18.6667 7H21V21H18.6667"
                                    fill="white"
                                />
                            </svg>
                        </ControlButton>
                    </DropdownMenu.Trigger>
                    <DropdownMenu.Portal container={fullscreenContainer}>
                        <DropdownMenu.Content
                            side="top"
                            align="end"
                            sideOffset={19}
                            alignOffset={-140}
                            className="bg-other-extra text-text-light-primary min-w-92 rounded-lg shadow-md z-50 max-h-(--radix-dropdown-menu-content-available-height) w-(--radix-dropdown-menu-trigger-width) origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto data-[state=closed]:overflow-hidden data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 duration-150"
                        >
                            ...
                            <div className="bg-other-paper grid grid-cols-2 gap-3 px-3 py-3">
                                ...
                                <div className="text-sm">
                                    ...
                                    <p className="line-clamp-3">{nextEpisode.description}</p>
                                </div>
                            </div>
                        </DropdownMenu.Content>
                    </DropdownMenu.Portal>
            ...
            <ControlDropdown
                ...
                triggerIcon={
                    ...
                    >
                        <path
                            d="M23.334 2.3335C23.9528 2.3335 24.5463 2.57933 24.9839 3.01691C25.4215 3.4545 25.6673 4.04799 25.6673 4.66683V18.6668C25.6673 19.2857 25.4215 19.8792 24.9839 20.3167C24.5463 20.7543 23.9528 21.0002 23.334 21.0002H7.00065L2.33398 25.6668V4.66683C2.33398 3.37183 3.38398 2.3335 4.66732 2.3335H23.334ZM4.66732 4.66683V20.0318L6.03232 18.6668H23.334V4.66683H4.66732ZM7.00065 8.16683H21.0007V10.5002H7.00065V8.16683ZM7.00065 12.8335H17.5007V15.1668H7.00065V12.8335Z"
                            fill="white"
                        />
                    </svg>
                }
            ...
            >
                <div className="flex flex-col">
                    ...
                    {SPEED_OPTIONS.map((option) => (
                        <DropdownMenu.Item
                            key={option.value}
                            onSelect={() => onPlaybackRateChange(option.value)}
                            className={`flex items-center gap-1 px-3 py-2 text-left text-sm cursor-pointer hover:bg-white/5 rounded outline-none ${playbackRate === option.value
                                    ? "text-white"
            ...
            <ControlButton onClick={onToggleFullscreen}>
                {isFullscreen ? (
                    ...
                    >
                        <path
                            d="M8.16536 11.6668H5.83203V5.8335H11.6654V8.16683H8.16536V11.6668ZM5.83203 16.3335H8.16536V19.8335H11.6654V22.1668H5.83203V16.3335ZM19.832 19.8335H16.332V22.1668H22.1654V16.3335H19.832V19.8335ZM16.332 8.16683V5.8335H22.1654V11.6668H19.832V8.16683H16.332Z"
                            fill="white"
                        />
                    </svg>
                ) : (
                    ...
                    >
                        <path
                            d="M5.83203 5.8335H11.6654V8.16683H8.16536V11.6668H5.83203V5.8335ZM16.332 5.8335H22.1654V11.6668H19.832V8.16683H16.332V5.8335ZM19.832 16.3335H22.1654V22.1668H16.332V19.8335H19.832V16.3335ZM11.6654 19.8335V22.1668H5.83203V16.3335H8.16536V19.8335H11.6654Z"
                            fill="white"
                        />
                    </svg>
                )}
