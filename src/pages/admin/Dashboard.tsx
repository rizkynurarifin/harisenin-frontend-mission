                                ...
                                <tr key={movie.id} className="hover:bg-white/5 transition-all duration-200">
                                    ...
                                    <td className="p-5 text-center">
                                        <div className="flex justify-center gap-3">
                                            <Link to={`/admin/edit/${movie.slug || movie.id}`} className="text-secondary hover:text-white transition-colors p-2 hover:bg-white/10 rounded-lg">
                                            ...
                                            <button onClick={() => handleDelete(String(movie.id))} className="text-red-500/70 hover:text-red-500 transition-colors p-2 hover:bg-red-500/10 rounded-lg">
                    ...
                    {paginatedMovies.map((movie) => (
                        <div key={movie.id} className="p-4 flex flex-col gap-4">
                            ...
                            <div className="flex gap-2 pt-2">
                                <Link to={`/admin/edit/${movie.slug || movie.id}`} className="flex-1 bg-white/5 hover:bg-white/10 transition-colors py-2 rounded-lg flex justify-center items-center gap-2 text-xs font-bold border border-white/5">
                                ...
                                <button onClick={() => handleDelete(String(movie.id))} className="flex-1 bg-red-500/10 hover:bg-red-500/20 text-red-400 transition-colors py-2 rounded-lg flex justify-center items-center gap-2 text-xs font-bold border border-red-500/20">
